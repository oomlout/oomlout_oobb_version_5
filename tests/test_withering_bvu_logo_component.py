...
from components.withering_bvu_logo import working


class WitheringBvuLogoComponentTests(unittest.TestCase):
    def test_action_builds_rounded_square_badge(self):
        ...
        self.assertEqual(badge["shape"], "withering_bvu_logo")
    ...
    def test_metadata_exposes_exact_component_name(self):
        ...
        self.assertEqual(metadata["name"], "withering_bvu_logo")
        self.assertIn("withering_bvu_logo", metadata["shape_aliases"])
