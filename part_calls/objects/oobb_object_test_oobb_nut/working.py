...
def define():
    ...
    if not d:
        d = {
            "name": "oobb_object_test_oobb_nut",
            "name_short": ["test_oobb_nut"],
            "name_long": "OOBB Object: Test Oobb Nut",
            "description": "Generates nut test fixtures across orientation, depth, and clearance variants.",
            "category": "OOBB Test",
            "variables": [
