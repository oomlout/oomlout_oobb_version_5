...
def define():
    ...
    if not d:
        d = {
            "name": "oobb_object_test_oobb_motor_servo_standard_01",
            "name_short": ["test_oobb_motor_servo_standard_01"],
            "name_long": "OOBB Object: Test Oobb Motor Servo Standard 01",
            "description": "Generates servo orientation and screw-rotation test fixtures for standard servo profiles.",
            "category": "OOBB Test",
            "variables": [
