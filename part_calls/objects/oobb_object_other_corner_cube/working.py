...
def define():
    ...
    if not d:
        d = {
            "name": "oobb_object_other_corner_cube",
            "name_short": ["other_corner_cube"],
            "name_long": "OOBB Object: Other Corner Cube",
            "description": "Auto-generated scaffold for other_corner_cube. EDIT THIS.",
            "category": "OOBB Other",
            "variables": [],
