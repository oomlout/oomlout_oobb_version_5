...
def define():
    ...
    if not d:
        d = {
            "name": "oobb_object_plate_ninety_degree",
            "name_short": ["plate_ninety_degree"],
            "name_long": "OOBB Object: Plate Ninety Degree",
            "description": "90-degree plate geometry with multi-axis hole patterns for thick plates.",
