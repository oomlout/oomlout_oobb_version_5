...
def define():
    ...
    if not d:
        d = {
            "name": "oobb_object_test_oobb_screw",
            "name_short": ["test_oobb_screw"],
            "name_long": "OOBB Object: Test Oobb Screw",
            "description": "Generates screw test fixtures across orientation, nut, and clearance variants.",
            "category": "OOBB Test",
            "variables": [
                {"name": "style", "description": "Screw style variant (socket_cap/countersunk/self_tapping).", "type": "string", "default": "socket_cap"},
