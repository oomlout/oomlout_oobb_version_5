...
def define():
    ...
    if not d:
        d = {
            "name": "oobb_object_test_motor_tt_01",
            "name_short": ["test_motor_tt_01"],
            "name_long": "OOBB Object: Test Motor Tt 01",
            "description": "Generates TT motor fit-test fixtures for body clearances.",
            "category": "OOBB Test",
            "variables": [
