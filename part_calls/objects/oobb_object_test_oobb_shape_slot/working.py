...
def define():
    ...
    if not d:
        d = {
            "name": "oobb_object_test_oobb_shape_slot",
            "name_short": ["test_oobb_shape_slot"],
            "name_long": "OOBB Object: Test Oobb Shape Slot",
            "description": "Auto-generated scaffold for test_oobb_shape_slot. EDIT THIS.",
            "category": "OOBB Test",
            "variables": [],
