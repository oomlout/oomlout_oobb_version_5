...
_NAME = "withering_rise_logo"
_CACHE_NAME = "withering_rise_logo.svg"
...
def describe():
    ...
    d["name"] = _NAME
    d["name_long"] = "Withering RISE Athlete Village Logo"
    d["description"] = (
        "Rounded-square RISE athlete-village badge with the traced SVG regions "
        "subtracted from the top face for engraving or colour inlay."
    )
    d["shape_aliases"] = [_NAME, "withuering_rise_logo"]
    return d
