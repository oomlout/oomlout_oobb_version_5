...
module gridflock(
    ...
    cell_override = "",
    top_slice = 0,
    test_pattern_override = 0
) {
    effective_plate_size = is_undef(plate_size) ? [
        gridfinity_width * baseplate_dimensions[0],
        gridfinity_depth * baseplate_dimensions[1]
    ] : plate_size;
    effective_test_pattern = test_pattern_override < 0 ? 0 : test_pattern_override;
    ...
    if (effective_test_pattern == 0) {
        main();
    } else if (effective_test_pattern == 1) {
        test_pattern_half();
    } else if (effective_test_pattern == 2) {
        test_pattern_padding();
    } else if (effective_test_pattern == 3) {
        test_pattern_numbering();
    } else if (effective_test_pattern == 4) {
        test_pattern_wall();
    } else if (effective_test_pattern == 5) {
        test_pattern_click();
    }
}
...
gridflock(
    ...
    top_slice = top_slice,
    test_pattern_override = test_pattern
);
