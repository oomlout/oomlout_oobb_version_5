...
_NAME = "withering_mtli_logo"
_CACHE_NAME = "withering_mtli_logo.svg"
...
def describe():
    ...
    d["name"] = _NAME
    d["name_long"] = "Withering MTLi Logistics Logo"
    d["description"] = (
        "Rounded-square MTLi logistics badge with the SVG regions subtracted "
        "from the top face for engraving or colour inlay."
    )
    d["shape_aliases"] = [_NAME, "withuering_mtli_logo"]
    return d
