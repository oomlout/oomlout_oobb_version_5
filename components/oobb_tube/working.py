...
def describe():
    ...
    d = {}
    d["name"] = 'oobb_tube'
    d["name_long"] = 'OOBB Geometry Primitives: Tube'
    d["description"] = 'Tube cutout (hollow cylinder) across all render modes, with named/explicit radius and rotation support.'
