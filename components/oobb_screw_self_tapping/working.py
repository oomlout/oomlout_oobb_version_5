...
def describe():
    global d
    d = {}
    d["name"] = 'oobb_screw_self_tapping'
    d["name_long"] = 'OOBB Geometry Primitives: Self-Tapping Screw'
    d["description"] = "Self-tapping screw cutout; wrapper over oobb_screw with style='self_tapping' pre-set."
    d["category"] = 'Fasteners'
    d["shape_aliases"] = ['screw_self_tapping']
...
def action(**kwargs):
    """Self-tapping screw â€” delegates to oobb_screw with style pre-set."""
