...
_NAME = "withering_10north_logo"
_CACHE_NAME = "withering_10north_logo.svg"
...
def describe():
    ...
    d["name"] = _NAME
    d["name_long"] = "Withering 10 North Logo"
    d["description"] = (
        "Rounded-square 10 North badge with the SVG regions subtracted "
        "from the top face for engraving or colour inlay."
    )
    d["shape_aliases"] = [_NAME, "withuering_10north_logo"]
    return d
