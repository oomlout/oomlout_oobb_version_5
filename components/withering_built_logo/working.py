...
_NAME = "withering_built_logo"
_CACHE_NAME = "withering_built_logo.svg"
...
def describe():
    ...
    d["name"] = _NAME
    d["name_long"] = "Withering BUILT Building Expertise Logo"
    d["description"] = (
        "Rounded-square BUILT building-expertise badge with the SVG regions "
        "subtracted from the top face for engraving or colour inlay."
    )
    d["shape_aliases"] = [_NAME, "withuering_built_logo"]
    return d
